...
// Master Pack 다기능 최신글 추출
// ver.2021-04-09  $bo_table 같을때 캐시파일 구분자 추가
...
function latest_multi($skin_dir='', $bo_table, $rows=10, $subject_len=40, $cache_time=0, $options='')
{
	...
	if(!G5_USE_CACHE || $cache_fwrite) {
		...
		if (stristr($options, "wr_2_asc"))			$sql_order .= " wr_2 asc, ";
		if (stristr($options, "wr_2_desc"))			$sql_order .= " wr_2 desc, ";
